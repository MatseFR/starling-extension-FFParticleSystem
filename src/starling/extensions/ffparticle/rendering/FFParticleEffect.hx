 ...
 */
class FFParticleEffect extends FilterEffect 
{
	...
	public var testParticleAlpha:Bool = true;
	...
	public function writeParticleDataToBuffers(particles:Vector<Particle>, frameLUT:Vector<Frame>, offset:Int, numParticles:Int, systemAlpha:Float = 1):UInt
	{
	...
	private function get_maxCapacity():Int { return __maxCapacity; }
